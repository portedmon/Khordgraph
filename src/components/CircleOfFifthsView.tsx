  ...
  return (
    <div className="w-full h-full flex flex-col justify-between gap-2.5 min-h-0 overflow-hidden">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-xs font-bold text-white tracking-wide">
              五度圏 (Circle of Fifths) トレーニング
            </h3>
          </div>

          {/* Drill Mode Tabs */}
          <div className="flex flex-wrap items-center gap-1 bg-[#0F0F11] p-0.5 rounded-xl border border-white/5 text-xs">
            <button
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-3 flex-1 min-h-0">
        {/* Left: Circle Wheel */}
        <div className="lg:col-span-5 bg-[#151518] border border-white/5 rounded-2xl p-4 shadow-2xl flex flex-col items-center justify-center relative overflow-hidden">
          ...
          <div className="bg-[#151518] border border-white/5 rounded-2xl p-3.5 shadow-xl flex-none">
            <div className="flex items-center justify-between mb-2">
              <span className="text-[10px] uppercase tracking-widest text-white/40 font-bold flex items-center gap-1.5">
                ...
                {activeKey.majorName} Major ダイアトニックコード (Diatonic Chords):
              </span>
            </div>
